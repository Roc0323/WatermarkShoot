...
import com.roc.baselibrary.state.CameraMachine;
import com.roc.baselibrary.util.FileUtil;
import com.roc.baselibrary.util.LogUtil;
import com.roc.baselibrary.util.ScreenUtils;
import com.roc.baselibrary.view.CameraView;
...
//    private static final String TAG = "JCameraView";
    ...
    private int iconCancel = 0;       //取消图标
    private int iconConfirm = 0;      //确认图标
    ...
    private void initView() {
        ...
        mCaptureLayout.setIconSrc(iconLeft, iconRight,iconConfirm,iconCancel);
