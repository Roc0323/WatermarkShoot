...
import com.roc.baselibrary.listener.CaptureListener;
import com.roc.baselibrary.listener.ClickListener;
import com.roc.baselibrary.listener.ReturnListener;
import com.roc.baselibrary.listener.TypeListener;
...
public class CaptureLayout extends FrameLayout {
    ...
    private ImageView iv_custom_confirm;            //确认按钮
    private ImageView iv_custom_cancel;            //取消按钮
...
//        btn_cancel.setVisibility(GONE);
        iv_custom_cancel.setVisibility(GONE);
//        btn_confirm.setVisibility(GONE);
        iv_custom_confirm.setVisibility(GONE);
    }
...
//        btn_cancel.setVisibility(VISIBLE);
        iv_custom_cancel.setVisibility(VISIBLE);
//        btn_confirm.setVisibility(VISIBLE);
        iv_custom_confirm.setVisibility(VISIBLE);
//        btn_cancel.setClickable(false);
        iv_custom_cancel.setClickable(false);
//        btn_confirm.setClickable(false);
        iv_custom_confirm.setClickable(false);
        ObjectAnimator animator_cancel = ObjectAnimator.ofFloat(iv_custom_cancel, "translationX", layout_width / 4, 0);
        ObjectAnimator animator_confirm = ObjectAnimator.ofFloat(iv_custom_confirm, "translationX", -layout_width / 4, 0);
        ...
        set.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                iv_custom_cancel.setClickable(true);
                iv_custom_confirm.setClickable(true);
            }
        });
        set.setDuration(200);
        set.start();
...
//        });
        //取消按钮
        iv_custom_cancel = new ImageView(getContext());
        final LayoutParams btn_cancel_param = new LayoutParams(DensityUtil.dp2px(56f), DensityUtil.dp2px(56f));
        btn_cancel_param.gravity = Gravity.CENTER_VERTICAL;
        btn_cancel_param.setMargins(DensityUtil.dp2px(30f), 0, 0, 0);
        iv_custom_cancel.setLayoutParams(btn_cancel_param);
        iv_custom_cancel.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                if (typeLisenter != null) {
                    typeLisenter.cancel();
...
//                resetCaptureLayout();
        ...
        //确认按钮
        iv_custom_confirm = new ImageView(getContext());
        LayoutParams btn_confirm_param = new LayoutParams(DensityUtil.dp2px(56f), DensityUtil.dp2px(56f));
        btn_confirm_param.gravity = Gravity.CENTER_VERTICAL | Gravity.RIGHT;
        btn_confirm_param.setMargins(0, 0, DensityUtil.dp2px(30f), 0);
        iv_custom_confirm.setLayoutParams(btn_confirm_param);
        iv_custom_confirm.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                if (typeLisenter != null) {
...
//        });
        ...
        LayoutParams iv_custom_param_left = new LayoutParams(DensityUtil.dp2px(56f), DensityUtil.dp2px(56f));
        iv_custom_param_left.gravity = Gravity.CENTER_VERTICAL;
        iv_custom_param_left.setMargins(DensityUtil.dp2px(30f), 0, 0, 0);
        ...
        LayoutParams iv_custom_param_right = new LayoutParams(DensityUtil.dp2px(56f), DensityUtil.dp2px(56f));
        iv_custom_param_right.gravity = Gravity.CENTER_VERTICAL | Gravity.RIGHT;
        iv_custom_param_right.setMargins(0, 0, DensityUtil.dp2px(30f), 0);
        ...
        this.addView(iv_custom_cancel);
        this.addView(iv_custom_confirm);
...
//        btn_confirm.setVisibility(GONE);
    ...
    public void setIconSrc(int iconLeft, int iconRight,int iconConfirm,int iconCancel) {
        ...
        if (this.iconConfirm!=0){
            iv_custom_confirm.setImageResource(iconConfirm);
            iv_custom_confirm.setVisibility(VISIBLE);
        }
        if (this.iconCancel!=0){
            iv_custom_cancel.setImageResource(iconCancel);
            iv_custom_cancel.setVisibility(VISIBLE);
        }
    }
